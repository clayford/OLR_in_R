...
Notice we get the same answer. In other words, the Treatment effect is proportional to the ordered category level used to determine cumulative probability. That's the proportional odds assumption. _The coefficients are independent of the levels of the ordered response_. It doesn't matter whether we go from "None" to "Some", or "Some" to "Marked", the effect of Treatment is the same.
...
```{r}
arth_p <- xtabs(~ Improved, data = Arthritis) |> 
  proportions() |>
